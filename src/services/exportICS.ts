...
((laDate.getDate() + 1)<11? "0" + laDate.getDate().toString():laDate.getDate().toString())+"T"+(laDate.getHours() <10? "0"+laDate.getHours(): laDate.getHours()).toString() + (laDate.getMinutes() ==0? "0"+laDate.getMinutes():laDate.getMinutes()).toString() + `00`+`
...
((laDateFin.getDate() + 1)<11? "0" + laDateFin.getDate().toString():laDateFin.getDate().toString())+"T"+(laDateFin.getHours() <10? "0"+laDateFin.getHours(): laDateFin.getHours()).toString() + (laDateFin.getMinutes() ==0? "0"+laDateFin.getMinutes():laDateFin.getMinutes()).toString() + `00`+`
...
END:VEVENT\n`
    ...
    calendar.sync.parseICS(fileContent);
